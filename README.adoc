...
It simplifies the configuration required to create and start an https://github.com/quickfix-j/quickfixj/blob/QFJ_RELEASE_3_0_0/quickfixj-core/src/main/java/quickfix/Initiator.java[Initiator] or https://github.com/quickfix-j/quickfixj/blob/QFJ_RELEASE_3_0_0/quickfixj-core/src/main/java/quickfix/Acceptor.java[Acceptor], and handles the lifecycle of the https://github.com/quickfix-j/quickfixj/blob/QFJ_RELEASE_3_0_0/quickfixj-core/src/main/java/quickfix/Connector.java[Connector].
