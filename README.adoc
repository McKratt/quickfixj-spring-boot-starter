...
image:https://img.shields.io/badge/quickfixj-{quickfixj-version}-blue.svg["QuickFIX/J {quickfixj-version}", link="https://github.com/quickfix-j/quickfixj"]
...
It simplifies the configuration required to create and start an https://github.com/quickfix-j/quickfixj/blob/QFJ_RELEASE_3_0_1/quickfixj-core/src/main/java/quickfix/Initiator.java[Initiator] or https://github.com/quickfix-j/quickfixj/blob/QFJ_RELEASE_3_0_1/quickfixj-core/src/main/java/quickfix/Acceptor.java[Acceptor], and handles the lifecycle of the https://github.com/quickfix-j/quickfixj/blob/QFJ_RELEASE_3_0_1/quickfixj-core/src/main/java/quickfix/Connector.java[Connector].
...
Additionally, you need to follow the https://quickfixj.org/docs/configuration[configuration guide]
